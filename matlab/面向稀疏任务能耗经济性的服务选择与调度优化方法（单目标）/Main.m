...
candidate_schedule_strategy = ["FSGS", "PEEA"];

for schedule_i = 1:length(candidate_schedule_strategy)

    save('current_parameters1', "candidate_schedule_strategy", "schedule_i")
    clear
    load('current_parameters1')

    schedule_strategy = candidate_schedule_strategy(schedule_i);
...
% %         % test
    ...
    best_individual_Energy = Energy_dimensionless(Population_index(1, 1), :);
